    ...
    >
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-bold text-white mt-4 mb-1">Create your account</h1>
          <p className="text-white/60 text-sm">Start your first league for free</p>
        </div>
        ...
        <div className="bg-white rounded-3xl px-8 py-10 shadow-2xl">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/login" className="font-medium" style={{ color: "#2D6A4F" }}>
              Sign in
            </Link>
          </p>
